  ...
  return (
    <div className="container-fluid style">
      <div className="row justify-content-between">
        <div className="col-lg-3 style__content">
          <h2>Thay đổi bản thân</h2>
          <p className="fs-3">Phong cách ấn tượng</p>
          <p className="fs-5">
          ...
          <a href="/" className="style__content__btn text-decoration-none">
            Xem thêm
          </a>
        </div>
        <div className="col-xs-6 col-lg-2  style__img">
          <img
        ...
        <div className="col-lg-2 style__img">
          <img
